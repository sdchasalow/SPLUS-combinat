...
function(x, n)
{
#   DATE WRITTEN:  14 April 1994           LAST REVISED:  1 April 1998
#   AUTHOR:  Scott D. Chasalow
#
#   DESCRIPTION:
#         Generate all permutations of the elements of x taken two at a time. 
#         If x is missing,  generate all permutations of 1:n taken two
#         at a time (that is,  the indices of x that would give all 
#         permutations of the elements of x if x with length n had been given).
